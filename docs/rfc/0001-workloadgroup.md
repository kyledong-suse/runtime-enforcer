...
- `WorkloadSecurityPolicy` share many fields with `WorkloadSecurityPolicyProposal`.
  - `WorkloadSecurityPolicy` could be created based on a `WorkloadSecurityPolicy` by the user when they think the system learnt enough of their workload behavior.
